-- Havyn full Supabase install with Social Beta.
-- Use this when the project does not have the base Havyn tables yet.
...
drop policy if exists "room members can insert chat" on public.chat_messages;
